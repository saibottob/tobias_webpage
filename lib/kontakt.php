...
?> <html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="user-scalable=no,width=device-width,initial-scale=1"><meta name="apple-mobile-web-app-capable" content="yes"><title>Tobias Gatschet</title><link href="index.css" rel="stylesheet"></head><body><header><div class="logo_section"><div class="logo"><img src="./assets/images/logo_gruenliberale_RGB.jpg" alt="glp Logo"></div><div class="name">TOBIAS GATSCHET</div></div></header><nav><input type="checkbox" id="menu_check"> <label for="menu_check" class="menu_checkbtn"><i class="fas fa-bars"></i></label><ul><li><a href="./index.html">Über mich</a></li><li><a href="./politic.html">Politik</a></li><li><a href="./beruf.html">Berufserfahrung / Ausbildung</a></li><li class="active"><a href="#">Kontakt</a></li></ul></nav> <?php
			if(!empty($succcess)){
